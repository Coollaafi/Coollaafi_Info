...
| (2) 기존연구와의 비교 | AI를 통한 옷 추천 기능이 있는 서비스와 비교하였다.<br> '유저의 새인적 성향을 고려한 옷을 추천 받을 수 있나요?', '유저가 가지고 있는 옷 중에서 추천 받을 수 있나요?',<br>![비교](https://github.com/user-attachments/assets/a8cd6744-48cc-4399-adf6-f24c415ab030)|
